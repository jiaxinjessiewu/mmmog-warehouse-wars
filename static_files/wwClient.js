...
function login(){
	...
	$.ajax({
		...
		username="";
                    password="";
                    init();
 console.log(data["error"]); $("#loginstatus").html(data["error"]);}
                   else{
                   if("profile" in data){
                     username =$("#loguser").val();
                      password= $("#logpw").val();
...
function signup(){
   ...
   if(valid){
	...
	$.ajax({
               ...
               data: {"_id": $("#registeruser").val(), password: $("#registerpasswd").val(), email:$("#registeremail").val()}
               }).done(function(data){
                       if(data["error"]){
...
function insertNewScore(){
    $.ajax({
      method: "POST",
      url: "/ww/api/newscore",
      data: {"username": username,"score": score, "authorization":encryption(username)}
    }).done(function(data){
      if(data["error"]){
...
function updateProfile(){
    ...
    if(valid){
        $.ajax({
               ...
               data: {"_id":username ,password: $("#updatepasswd").val(), email:$("#updateemail").val()}
